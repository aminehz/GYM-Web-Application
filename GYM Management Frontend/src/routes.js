...
const UserManagement = React.lazy(() => import('./views/view/UserManagement'));
const CourseManagement = React.lazy(() => import('./views/CourseManagement'));
const MembershipManagement = React.lazy(() =>
  import('./views/MembershipManagement')
);
const SubscriptionManagement = React.lazy(() =>
  import('./views/SubscriptionManagement')
);
